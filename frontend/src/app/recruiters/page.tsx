  ...
  try {
    ...
    return (
      <div className="mx-auto max-w-7xl space-y-4 px-4 sm:px-6 lg:px-8">
        <h1 className="text-xl font-bold text-gray-900 sm:text-2xl lg:text-3xl">Recruiter Management</h1>
...
function SummaryCard({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-[0_1px_3px_rgba(0,0,0,0.06)] sm:p-6">
      <div
